...
module.exports = {
	config: {
		...
		guide: {
			...
			en: "{pn}: 𝒑𝒐𝒖𝒓 𝒗𝒐𝒊𝒓 𝒍𝒆𝒔 𝑪𝒎𝒅𝒔."
				...
				+ "\n   {pn} <command name> [-i | info]: 𝑨𝒇𝒇𝒊𝒄𝒉𝒆 𝒍𝒆𝒔 𝑰𝒏𝒇𝒐𝒓𝒎𝒂𝒕𝒊𝒐𝒏𝒔 𝒄𝒐𝒏𝒄𝒆𝒓𝒏𝒂𝒏𝒕 𝒍𝒂 𝑪𝒎𝒅."
				+ "\n   {pn} <command name> [-r | role]: 𝑨𝒇𝒇𝒊𝒄𝒉𝒆 𝒍𝒆 𝑷𝒐𝒖𝒗𝒐𝒊𝒓 (0, 1, 2, .) [𝑺𝒊 𝒄'𝒆𝒔𝒕 𝑶𝒖𝒗𝒆𝒓𝒕 𝒂̀ 𝑻𝒐𝒖𝒕 𝒍𝒆 𝒎𝒐𝒏𝒅𝒆(0) 𝒐𝒖 𝒔𝒊 𝒄'𝒆𝒔𝒕 𝑹𝒆́𝒔𝒆𝒓𝒗𝒆́ 𝒂𝒖𝒙 𝑨𝒅𝒎𝒊𝒏𝒔(1 𝒆𝒕 2)."
				+ "\n   {pn} <command name> [-a | alias]: 𝑨𝒇𝒇𝒊𝒄𝒉𝒆 𝒍𝒆𝒔 𝑨𝒖𝒕𝒓𝒆𝒔 𝑵𝒐𝒎𝒔."
		},
		priority: 1
	},
	...
	langs: {
		...
		en: {
			help: "╔═❃• 𝑺𝑨𝑰𝑫𝒀𝑳 •❃═╗\n%1\n ╚═❃• 𝑺𝑨𝑰𝑫𝒀𝑳 •❃═╝\n➳ 𝒑𝒂𝒈𝒆  [ %2/%3 ]\n➳𝑬𝑪𝑹𝑰𝑺  %5help <page> 𝒑𝒐𝒖𝒓 𝒗𝒐𝒊𝒓 𝒍𝒆𝒔 𝑪𝒎𝒅𝒔 𝒔𝒖𝒓 𝒄𝒆𝒕𝒕𝒆 𝑷𝒂𝒈𝒆..💖\n➳𝗘́𝗖𝗥𝗜𝗧  %5help <𝑵𝒐𝒎 𝒅𝒆 𝒍𝒂 𝑪𝒎𝒔>  𝒑𝒐𝒖𝒓 𝒗𝒐𝒊𝒓 𝒄𝒐𝒎𝒎𝒆𝒏𝒕 𝒔𝒐𝒏 𝑭𝒐𝒏𝒄𝒕𝒊𝒐𝒏𝒏𝒆𝒎𝒆𝒏𝒕..💖\n├────────⭔\n│ %6\n╰─────────────⭓",
			...
			roleText2: "2 (𝑳𝒆𝒔 𝑨𝒅𝒎𝒊𝒏𝒔𝒔 𝒅𝒖 𝑩𝒐𝒕)",
